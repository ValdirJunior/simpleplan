...
<p align="justify"> Este trabalho consiste na criação de uma aplicação que utiliza do método <strong>Simplex</strong> na resolução de problemas de <strong>programação linear</strong> com objetivo de <strong>maximizar e minimizar</strong>. O software foi projetado baseado na técnica de <strong>MVP  (Minimum Viable Product)</strong> que está diretamente conectada aos conceitos de Lean Starup e tem intuido de efetuar testes para a verificação da viabilidade do negócio, disponibilizando versões do produto aos stakeholders para se obter um feedback que agregue no desenvolvimento, ajuste e melhorias do projeto. Durante o decorrer do processo de desenvolvimento do SimplePlan, a equipe enfrentou alguns problemas relacionados aos prazos e entregas dos MVPs definidos, porém,  os casos foram reportados aos mais interessados, e em comum acordo, as entregas foram atualizada. O software foi entregue seguindo as solicitações do cliente, disponibilizando um produto dinâmico e simples, atendendo aos objetivos principais referentes a maximização e minimização de problemas de programação linear.</p>
